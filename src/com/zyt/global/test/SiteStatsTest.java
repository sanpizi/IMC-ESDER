...
import com.zyt.global.SiteStats;
 ...
 */
public class SiteStatsTest {
    private static final Logger logger = LogManager.getLogger(SiteStatsTest.class);
    ...
    public static void main(String[] args) throws ClassNotFoundException, SQLException, IOException {
        ...
        SiteStats data = new SiteStats(conn);
